...
-- Name: csdatabase; Type: DATABASE; Schema: -; Owner: author
--

CREATE DATABASE "csdatabase" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.UTF-8';


ALTER DATABASE "csdatabase" OWNER TO pgsync;

\connect -reuse-previous=on "dbname='csdatabase'"
