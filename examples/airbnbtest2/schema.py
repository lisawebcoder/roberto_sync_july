...
class Response(Base):
    ...
    booking_id = sa.Column(sa.Integer, sa.ForeignKey(Booking.id))
    rating = sa.Column(sa.SmallInteger, nullable=True)
    response_body = sa.Column(sa.Text, nullable=True)
    booking = sa.orm.relationship(
        Booking,
        backref=sa.orm.backref("booking"),
    )
...
#May30th2023--setup these tables--
class Booking_Extra(Base):
    __tablename__ = "booking_extra"
...
class Child_Table1(Base):
    __tablename__ = "child_table1"
    __table_args__ = (UniqueConstraint("description"),)
    id = sa.Column(sa.Integer, primary_key=True)    
    description = sa.Column(sa.String, nullable=False)
...
class Child_Table3(Base):
    __tablename__ = "child_table3"
    __table_args__ = (UniqueConstraint("description"),)
    id = sa.Column(sa.Integer, primary_key=True)    
    description = sa.Column(sa.String, nullable=False)

class Child_Table4(Base):
    __tablename__ = "child_table4"
    __table_args__ = (UniqueConstraint("name"),)
    id = sa.Column(sa.Integer, primary_key=True)    
    name = sa.Column(sa.String, nullable=False)
...
class Child_Table5(Base):
    __tablename__ = "child_table5"
    __table_args__ = (UniqueConstraint("description"),)
    id = sa.Column(sa.Integer, primary_key=True)    
    description = sa.Column(sa.String, nullable=False)

class Child_Table6(Base):
    __tablename__ = "child_table6"
    __table_args__ = (UniqueConstraint("name"),)
    id = sa.Column(sa.Integer, primary_key=True)    
    name = sa.Column(sa.String, nullable=False)
...
class Child_Table7(Base):
    __tablename__ = "child_table7"
    __table_args__ = (UniqueConstraint("description"),)
    id = sa.Column(sa.Integer, primary_key=True)    
    description = sa.Column(sa.String, nullable=False)

class Child_Table8(Base):
    __tablename__ = "child_table8"
    __table_args__ = (UniqueConstraint("name"),)
    id = sa.Column(sa.Integer, primary_key=True)    
    name = sa.Column(sa.String, nullable=False)

class Table7(Base):
    __tablename__ = "table7"
    __table_args__ = (UniqueConstraint("name"),)
    id = sa.Column(sa.Integer, primary_key=True)    
    name = sa.Column(sa.String, nullable=False)

class Child_Table9(Base):
    __tablename__ = "child_table9"
    __table_args__ = (UniqueConstraint("description"),)
    id = sa.Column(sa.Integer, primary_key=True)    
    description = sa.Column(sa.String, nullable=False)

class Child_Table10(Base):
    __tablename__ = "child_table10"
    __table_args__ = (UniqueConstraint("name"),)
    id = sa.Column(sa.Integer, primary_key=True)    
    name = sa.Column(sa.String, nullable=False)
